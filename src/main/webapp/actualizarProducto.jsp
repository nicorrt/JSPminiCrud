...
<body>
	<div class="container">
		<form id="contact" action="ControladorProductos" method="get">
			...
			<h3>¿Quieres Actualizar un Producto?</h3>
			<h4>Cambia el campo que desees:</h4>
			<fieldset>
				<input placeholder="Sección" type="text" name="seccion" value="${ProductoActualizar.seccion}" required >
			</fieldset>
			<fieldset>
				<input placeholder="Nombre Artículo" type="text" name="NArt" value="${ProductoActualizar.nombreArticulo}"
					required>
			</fieldset>
			<fieldset>
				<input placeholder="Precio" type="text" name="precio" value="${ProductoActualizar.precio}" required>
			</fieldset>
			<fieldset>
				<input placeholder="Importado" type="text" name="importado" value="${ProductoActualizar.importado}" required>
			</fieldset>
			<fieldset>
				<input placeholder="Pais de Origen" type="text" name="POri" value="${ProductoActualizar.pOrigen}" required >
			</fieldset>
			<fieldset>
